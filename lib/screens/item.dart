...
class _ItemsScreenState extends State<ItemsScreen> {
  ...
  Future<void> _checkAndUpdateItem(String tagId) async {
    ...
    if (existingItem.tagId.isNotEmpty) {
      ...
      //     context,
      //     MaterialPageRoute(
      //         builder: (BuildContext context) => main._getAppBarTitle(3)));
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Item>>(
        future: _itemRepository.getAllItems(uid),
                    ...
                    children: [
                      SegmentedButton<int>(
                        ...
                        segments: [
                          ButtonSegment(
                              value: 1,
                              label: Icon(Icons.backpack,
                                  color: Colors.grey[700])),
                          ButtonSegment(
                              value: 0,
                              label: Icon(Icons.no_backpack,
                                  color: Colors.grey[700])),
                        ],
